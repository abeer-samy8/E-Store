      ...
      if(cartItems && productSection){
         ...
         quantityInputs.forEach(input => {
             input.addEventListener('input', (event) => {
                 ...
                 let productNumbers = localStorage.getItem('cardNumbers');
                 if (productNumbers) {
                     localStorage.setItem('cardNumbers', parseInt(productNumbers) + (productCount - oldProductCount));
                     document.querySelector('.cartt span').textContent = parseInt(productNumbers) + (productCount - oldProductCount);
                 }
